...
TARGET_PROGRAM=["python",os.path.join("contest","ABC319","d.py"),"-Xfrozen_modules=off"]#チェックするプログラムの実行コマンド
CORRECT_PROGRAM=["python",os.path.join("test","correct.py"),"-Xfrozen_modules=off"]#正しいと思われるプログラムの実行コマンド
