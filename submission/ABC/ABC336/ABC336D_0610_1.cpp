...
ll calc(ll N, ll center, vector<ll> &A)
{
    ll height = A[center];
    ll k = height - 1;
    ll l = center - 1;
...
/**
 *方針メモ欄
 * 真ん中決めうって、そこから左右に1ずつマイナスしたい
 * 目標値に満たなかった場合は、Kを下げるしかないので、低いほうに合わせてKを減らす
 * Nが偶数の場合は真ん中2本で同じ操作を二回行う
 */
//======================
/**
 * エントリポイント
