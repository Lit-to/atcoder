...
void solve()
{
    ...
    */
    ...
    auto evalDistance = [&](ll i, ll j) -> ll
    { return (edges[i].X - edges[j].X) * (edges[i].X - edges[j].X) + (edges[i].Y - edges[j].Y) * (edges[i].Y - edges[j].Y); };
